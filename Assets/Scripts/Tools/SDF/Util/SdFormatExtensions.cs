...
namespace SDFormat
{
	...
	public static class Extensions
	{
		...
		/// </summary>
		public static Element FindElementByPath(this Element root, string path)
		{
		...
		/// </summary>
		public static List<Element> FindAllElementsByPath(this Element root, string path)
		{
		...
		private static Element FindWithPredicate(Element parent, string childName, string predicate)
		{
		...
		private static bool MatchesPredicate(Element elem, string predicate)
		{
			// [text()='value']
		...
		/// </summary>
		public static T GetAttribute<T>(this Element element, string attributeName, T defaultValue = default)
		{
			var attr = element?.GetAttribute(attributeName);
			if (attr == null)
				return defaultValue;
			return ConvertValue(attr.GetAsString(), defaultValue);
		}

		/// <summary>
		/// Get child elements matching a tag name from an Element.
		/// </summary>
		public static List<Element> GetElements(this Element element, string tagName)
		{
			if (element == null)
		...
		public static string LibraryName(this Plugin plugin)
		{
		...
		public static string RawXml(this Plugin plugin)
		{
			return plugin.Element?.ToString() ?? string.Empty;
		}

		public static string ParentRawXml(this Plugin plugin)
		{
		...
		/// </summary>
		public static T GetValue<T>(this Plugin plugin, string path, T defaultValue = default)
		{
			var elem = FindElementByPath(plugin.Element, path);
			if (elem?.Value == null)
				return defaultValue;
			return ConvertValue(elem.Value.GetAsString().Trim(), defaultValue);
		}

		/// <summary>
		/// Check if a plugin has a child element at the given path (supports nested paths).
		/// </summary>
		public static bool HasElement(this Plugin plugin, string path)
		{
		...
		/// </summary>
		public static bool IsValidNode(this Plugin plugin, string path)
		{
			return FindElementByPath(plugin.Element, path) != null;
		}
		...
		/// </summary>
		public static Element GetElement(this Plugin plugin, string path)
		{
		...
		/// </summary>
		public static T GetAttribute<T>(this Plugin plugin, string attributeName, T defaultValue = default)
		{
		...
		/// </summary>
		public static List<Element> GetElements(this Plugin plugin, string tagName)
		{
		...
		/// </summary>
		public static bool GetValues<T>(this Plugin plugin, string path, out List<T> values)
		{
			values = new List<T>();
			if (plugin.Element == null)
				return false;
		...
		/// </summary>
		public static T GetAttributeInPath<T>(this Plugin plugin, string path, string attributeName, T defaultValue = default)
		{
			var elem = FindElementByPath(plugin.Element, path);
			if (elem == null)
				return defaultValue;
		...
		/// </summary>
		public static T GetAttributeInPath<T>(this Plugin plugin, string path, string attributeName)
		{
		...
		/// </summary>
		public static string OriginalName(this Model model)
		{
		...
		/// </summary>
		public static bool IsNested(this Model model)
		{
		...
		/// </summary>
		public static bool SelfCollide(this Link link)
		{
		...
		/// </summary>
		public static (string name, double voltage)? GetBattery(this Link link)
		{
		...
		/// </summary>
		public static int GetMetaLayer(this Visual visual)
		{
		...
		/// </summary>
		public static bool Visualize(this Sensor sensor)
		{
		...
		/// </summary>
		public static ContactData GetContactData(this Sensor sensor)
		{
		...
		/// </summary>
		public static List<CameraSensor> GetCameras(this Sensor sensor)
		{
			var cameras = new List<CameraSensor>();
		...
		{
			return geometry.Type == GeometryType.Empty;
		}
		...
		/// </summary>
		public static string TypeString(this Light light)
		{
		...
		/// </summary>
		public static string TypeString(this Joint joint)
		{
		...
		/// </summary>
		public static bool HasJointLimits(this JointAxis axis)
		{
		...
		public static T GetElementValue<T>(Element parent, string childName, T defaultValue = default)
		{
			if (parent == null)
				return defaultValue;
			...
			return ConvertValue(child.Value.GetAsString().Trim(), defaultValue);
		}
