...
public class MeshExtrusion
{
	...
	* 	- A general edge extraction algorithm is employed. 
	*	(Same algorithm as traditionally used for stencil shadows) 
	*	Once all unique edges are found, all edges that connect to only one triangle are extracted.
