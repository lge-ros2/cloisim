...
> [!IMPORTANT]
> 🚨 CLOiSim has been upgraded to **Unity 6.6** (6000.6.2f1). Legacy versions based on Unity 2022.3 LTS are no longer maintained.
...
- **Unity**: Unity Editor 6000.6.2f1 (if building from source)
